...
const CACHE = 'ssic-v4';   /* BUMP THIS ON EVERY DEPLOY — activate() purges any cache whose name differs, which is the only thing that forces a stale shell out of a returning browser. */
